...
// Define keyframes for the pulse animation (from original Phase 1 code)
...
// This ensures the animation defined in the original CSS is available.
    ...
    useEffect(() => {
        ...
        const loadEditorScripts = async () => {
            try {
                ...
                await Promise.all([
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/header@2.8.1/dist/bundle.min.js', 'editorjs-header'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/paragraph@2.11.3/dist/bundle.min.js', 'editorjs-paragraph'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/list@1.9.0/dist/bundle.min.js', 'editorjs-list'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/code@2.9.0/dist/bundle.min.js', 'editorjs-code'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/table@2.3.0/dist/bundle.min.js', 'editorjs-table'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/quote@2.6.0/dist/bundle.min.js', 'editorjs-quote'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/raw@2.5.0/dist/bundle.min.js', 'editorjs-raw'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/image@2.9.0/dist/bundle.min.js', 'editorjs-image'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/marker@1.4.0/dist/bundle.min.js', 'editorjs-marker'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/warning@1.3.0/dist/bundle.min.js', 'editorjs-warning'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/delimiter@1.3.0/dist/bundle.min.js', 'editorjs-delimiter'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/inline-code@1.4.0/dist/bundle.min.js', 'editorjs-inline-code'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/link@2.6.0/dist/bundle.min.js', 'editorjs-link'),
                    loadScript('https://cdn.jsdelivr.net/npm/@editorjs/embed@2.7.0/dist/bundle.min.js', 'editorjs-embed'),
                ]);
                ...
                // Potentially show a user-facing error here if Editor.js is critical
            }
        };
...
function AuthPage() {
    ...
    return (
        ...
        >
            {/* Left Side - Hero Section (Restored as per original Phase 1 UI) */}
            <Box
                sx={{
...
function App() {
    ...
    return (
        <Box sx={{ fontFamily: 'Inter', minHeight: '100vh', backgroundColor: '#f5f7fa' }}>
            {currentPage !== 'auth' && (
